...
@app.command(no_args_is_help=True, help="""
    Transcript a video file: extract audio, transcribe and summarize it by using LLM. Usage Examples:\n
...
def summarize(
    ...
    context_window: int = typer.Option(2048, '-c', '--context-window', help='Custom context window size.'),
